public class BooleanGames {
     ...
     */
    public boolean exceeds(int num) { /* implement this method! */
        return (number > num);
    }
    ...
    /* Returns true if the instance variable, number, is even;
       returns false otherwise
     */
    public boolean isEven() { /* implement this method! */
        return (number % 2 == 0);
    }
     ...
     */
    public boolean isOdd() { /* implement this method! */
        return (number % 2 != 0);
    }
    ...
    /* Returns true if the instance variable, number, is a multiple of x;
       returns false otherwise
     */
    public boolean isMultipleOf(int x) { /* implement this method! */
        return (number % x == 0);
    }
